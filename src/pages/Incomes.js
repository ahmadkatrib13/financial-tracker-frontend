...
import { ReactComponent as IncomeSVG } from "../assets/images/BlueIncomes.svg";
...
function Incomes() {
  ...
  useEffect(() => {
    axios({
      method: "GET",
      url: `${process.env.REACT_APP_API_URI}api/transactions/total/incomes`,
      ...headers,
    }).then((res) => {
  ...
  useEffect(() => {
    ...
    axios({
      method: "GET",
      url: `${process.env.REACT_APP_API_URI}api/transactions/incomes?page=${pageNumber}`,
  ...
  useEffect(() => {
    const getCategories = async () => {
      try {
        let res = await axios({
          method: "GET",
          url: `${process.env.REACT_APP_API_URI}api/categories/income`,
          ...headers,
        });
